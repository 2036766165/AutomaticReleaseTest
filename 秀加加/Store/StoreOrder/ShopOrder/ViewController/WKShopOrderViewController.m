...
@interface WKShopOrderViewController ()

@property (nonatomic,strong) NSMutableArray *array;

@end

@implementation WKShopOrderViewController
...
-(void)initUi
{
    ...
    for(int i = 1;i < 6;i++)
    {
        WKAllOrderViewController *myOrderAllVc = [[WKAllOrderViewController alloc] initWithType:StoreType OrderListType:i CustomType:1];
