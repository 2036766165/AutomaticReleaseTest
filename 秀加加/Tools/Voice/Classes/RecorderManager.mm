...
//        OSStatus error = [[AVAudioSession sharedInstance] setActive:YES error:nil];
...
//            BOOL success = [audioSession overrideOutputAudioPort:AVAudioSessionPortOverrideSpeaker error:&newError];
//            if(!success)
//            {
//                NSLog(@"error doing outputaudioportoverride - %@", [newError localizedDescription]);
//            }
