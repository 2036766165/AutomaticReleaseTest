...
+ (NSDictionary *)keysFirstLetterlowercaseStringWith:(NSDictionary *)oldDict
{
    NSMutableDictionary *dictResult = [NSMutableDictionary new];
    [[oldDict allKeys] enumerateObjectsUsingBlock:^(id  _Nonnull obj, NSUInteger idx, BOOL * _Nonnull stop) {
        
        id object = oldDict[obj];
        
        obj = [(NSString *)obj stringByReplacingCharactersInRange:NSMakeRange(0, 1) withString:[[(NSString *)obj substringToIndex:1] lowercaseString]];

        if ([object isKindOfClass:[NSString class]] || [object isKindOfClass:[NSNumber class]]) {
            
            [dictResult setObject:object forKey:obj];

        }else if ([object isKindOfClass:[NSDictionary class]]){
          NSDictionary *dictSub = [self keysFirstLetterlowercaseStringWith:object];

            if (dictSub) {
                [dictResult setObject:dictSub forKey:obj];

            }
        }else if ([object isKindOfClass:[NSArray class]]){
            NSMutableArray *array = [NSMutableArray new];
            [object enumerateObjectsUsingBlock:^(id  _Nonnull obj, NSUInteger idx, BOOL * _Nonnull stop) {
                NSDictionary *dictSub = [self keysFirstLetterlowercaseStringWith:obj];
                
                [array addObject:dictSub];
            }];
        
            [dictResult setObject:array forKey:obj];
...
+ (NSDictionary *)keysFirstTransformStringWith:(NSDictionary *)oldDict isLowercase:(BOOL)isLowercase
{
    NSMutableDictionary *dictResult = [NSMutableDictionary new];
    [[oldDict allKeys] enumerateObjectsUsingBlock:^(id  _Nonnull obj, NSUInteger idx, BOOL * _Nonnull stop) {
        ...
        if (isLowercase == NO) {
            obj = [(NSString *)obj stringByReplacingCharactersInRange:NSMakeRange(0, 1) withString:[[(NSString *)obj substringToIndex:1] uppercaseString]];
        ...
        if ([object isKindOfClass:[NSString class]] || [object isKindOfClass:[NSNumber class]]) {
            ...
            NSDictionary *dictSub = [self keysFirstTransformStringWith:object isLowercase:isLowercase];
