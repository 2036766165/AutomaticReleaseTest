...
@interface WKFocusAndFansTableViewCell(){
    NSInteger _tapped;
}
...
@implementation WKFocusAndFansTableViewCell
...
//    if(self.type == 1)
//    {
//        [self.shareAnFocus mas_updateConstraints:^(MASConstraintMaker *make) {
...
//        }];
//    }
//    [self.shareAnFocus layoutIfNeeded];    
}
...
//    self.shareAnFocus = [[UIButton alloc] init];
//    [self.shareAnFocus addTarget:self action:@selector(shareEvent) forControlEvents:UIControlEventTouchUpInside];
//    [self.shareAnFocus setImage:shareImage forState:UIControlStateNormal];
//    [self addSubview:self.shareAnFocus];
//    [self.shareAnFocus mas_updateConstraints:^(MASConstraintMaker *make) {
//        make.right.equalTo(self.mas_right).offset(-10);
//        make.bottom.mas_offset(0);
//        make.size.mas_equalTo(CGSizeMake(35, 35));
...
//    UIImage *messageImage = [UIImage imageNamed:@"sixin"];
//    self.message = [[UIButton alloc] init];
//    [self.message setImage:messageImage forState:UIControlStateNormal];
//    [self.message addTarget:self action:@selector(messageEvent) forControlEvents:UIControlEventTouchUpInside];
//    [self addSubview:self.message];
//    [self.message mas_makeConstraints:^(MASConstraintMaker *make) {
//        make.right.equalTo(self.shareAnFocus.mas_left).offset(-5);
//        make.centerY.equalTo(self.shareAnFocus.mas_centerY);
//        make.size.mas_equalTo(CGSizeMake(25, 25));
//    }];

    CGFloat fanWidth = WKScreenW - headImage.size.width - levelImage.size.width + 10  - 25 - 50;
...
//点击头部
-(void)headEvent:(UITapGestureRecognizer*)tap{
 
      if (tap.numberOfTapsRequired == 1) {
    
              if(_clickCallBack)
              {
                  _clickCallBack(ClickHead);
              }
       }
...
//        if(self.click)
//        {
//            [self.shareAnFocus setImage:[UIImage imageNamed:@"fensi"] forState:UIControlStateNormal];
//            
//            if(_clickCallBack)
//            {
//                _clickCallBack(ClickFocus);
//            }
//        }
//        else
//        {
//            [self.shareAnFocus setImage:[UIImage imageNamed:@"fensiweiguan"] forState:UIControlStateNormal];
//            
//            if(_clickCallBack)
//            {
//                _clickCallBack(ClickFocusNot);
//            }
//        }
