//
//  WkMyOrderSellOrderViewController.m
//  秀加加
//
...
@interface WkMyOrderSellOrderViewController ()

@property (nonatomic,strong) NSMutableArray *array;

@end

@implementation WkMyOrderSellOrderViewController
...
-(void)initUi
{
    ...
    for(int i = 1;i < 6;i++)
    {
        ...
        WkMyOrderAllViewController *myOrderAllVc = [[WkMyOrderAllViewController alloc] initWithType:AuctionType OrderListType:i CustomType:2];
